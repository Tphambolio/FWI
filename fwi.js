...
// Province selector: 'AB' (default) or 'BC'. Persisted in localStorage by UI pages.
// fwi.js math is province-agnostic — only data tables and danger thresholds differ.
let _province = (typeof localStorage !== 'undefined' && localStorage.getItem('fwi_province')) || 'AB';
function setProvince(p) {
  _province = p;
  if (typeof localStorage !== 'undefined') localStorage.setItem('fwi_province', p);
}
function getProvince() { return _province; }
